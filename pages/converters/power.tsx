...
const pageTitle = 'Power converter'
const pageDescription = ''
const pageUrl = `${SEO.siteUrl}/converters/power`
...
const PowerPage: React.FC<Props> = ({ valueFrom, unitFrom, valuesList, ...props }) => {
...
export default withUnitConverter(PowerPage, units, { unitsListEnabled: true })
