...
const units: Unit[] = [
  new Unit('radian', 'rad'),
  new Unit('degree', 'deg'),
  new Unit('gradian', 'grad'),
  new Unit('cycle', 'cycle'),
  new Unit('arcsecond', 'arcsec'),
  new Unit('arcminute', 'arcmin')
]

const pageTitle = 'Angles Units converter'
const pageDescription = ''
const pageUrl = `${SEO.siteUrl}/converters/angles`
