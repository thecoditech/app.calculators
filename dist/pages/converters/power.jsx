...
const units = [
    new unit_1.Unit('watt', 'W'),
    new unit_1.Unit('hp', 'hp')
];
const pageTitle = 'Power converter';
const pageDescription = '';
const pageUrl = `${next_seo_config_1.default.siteUrl}/converters/power`;
...
exports.default = withUnitConverter_1.withUnitConverter(PowerPage, units);
