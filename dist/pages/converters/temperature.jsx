...
const units = [
    new unit_1.Unit('kelvin', 'K'),
    new unit_1.Unit('celsius', 'degC'),
    new unit_1.Unit('fahrenheit', 'degF'),
    new unit_1.Unit('rankine', 'degR')
];
const pageTitle = 'Temperature converter';
const pageDescription = '';
const pageUrl = `${next_seo_config_1.default.siteUrl}/converters/temperature`;
...
exports.default = withUnitConverter_1.withUnitConverter(TemperaturePage, units);
//# sourceMappingURL=temperature.jsx.map