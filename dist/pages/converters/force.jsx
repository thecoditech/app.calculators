...
const units = [
    new unit_1.Unit('newton', 'N'),
    new unit_1.Unit('dyne', 'dyn'),
    new unit_1.Unit('poundforce', 'lbf'),
    new unit_1.Unit('kip', 'kip')
];
const pageTitle = 'Force converter';
const pageDescription = '';
const pageUrl = `${next_seo_config_1.default.siteUrl}/converters/force`;
...
exports.default = withUnitConverter_1.withUnitConverter(ForcePage, units);
//# sourceMappingURL=force.jsx.map